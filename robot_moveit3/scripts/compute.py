...
group_name = "left_joints"  # Change this to your MoveIt! group name
...
num_samples = 100  # Increase for better resolution
reachable_points = []


invalid_joint_names = ['joint_0', 'joint_1', 'joint_5', 'joint_9', 'joint_13', 'joint_15']
